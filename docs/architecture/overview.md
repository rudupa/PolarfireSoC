...
2. **Boot Flow** – Hart Software Services (HSS) loads the Libero bitstream, boots Linux on U54_0/U54_1 (SMP), brings up QNX on U54_2, and launches Zephyr on U54_3 for the AMP configuration.
